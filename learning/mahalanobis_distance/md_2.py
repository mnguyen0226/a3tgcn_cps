...
temp_err_arr = pred_arr - gt_arr
print(f"Temp: {temp_err_arr}")

# append to error database
err_arr = np.stack((err_arr, temp_err_arr))  # err_arr
print(f"Stacked: {err_arr}")

# calculate the mean_error_arr
mean_err_arr = np.mean(err_arr, axis=0)
# print(mean_err_arr)

# calculates the covariance matrix
df = np.stack((temp_err_arr, mean_err_arr))
...
md_ = (
    (temp_err_arr - mean_err_arr).T.dot(covariance_pm1).dot(temp_err_arr - mean_err_arr)
)
