...
# File trains simple neural network in MNIST, saves, and loads model locally.
...
def load_and_retrain(): # expect the accuracy to increase
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, model_path)
        print("Model saved in file: %s" % model_path) # either model_path or save_path works
...
def main():
    # train_and_eval() 
    # load_and_retrain() # and save model
    load_and_eval()
