...
##########
def data_preprocessing(num_line=9, label_dataset=EVAL_CLEAN_LABEL_DIR, preds_dataset=EVAL_CLEAN_PREDS_DIR):
...
def calculate_md_poison():
    ...
    # Get lists
    df_eval_labels, df_eval_preds = data_preprocessing(num_line=483, label_dataset=EVAL_POISON_LABEL_DIR, preds_dataset=EVAL_POISON_PREDS_DIR)
...
def calculate_md_stacked():
    ...
    # Get lists
    df_eval_labels, df_eval_preds = data_preprocessing(num_line=2227, label_dataset=STACKED_LABEL_DIR, preds_dataset=STACKED_PREDS_DIR)
