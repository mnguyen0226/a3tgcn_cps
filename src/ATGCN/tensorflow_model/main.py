...
OP_BATCH_SIZE = 128 # 32  # 24 hours (1 days)  # (TGCN: 16, 32) # batch size is the number of samples that will be passed through to the network at one time (in this case, number of 12 rows/seq_len/time-series be fetched and trained in TGCN at 1 time)
...
def load_and_keep_train_clean_dataset():
    ...
    saved_path = "out/tgcn/tgcn_scada_wds_lr0.01_batch100_unit64_seq8_pre1_epoch101/model_100/TGCN_pre_100-100"
